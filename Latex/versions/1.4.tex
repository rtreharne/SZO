...
\end{equation}
where $n_t$ is the trap density and $\varepsilon_{\infty}$ is the high frequency dielectric permittivity ($\varepsilon_{\infty}\sim8.3$ for single crystal ZnO \cite{Ashkenov203}). The pre-factor $\mu_0$ is the internal mobility of the grain, expressed as
\begin{equation}
\label{eqn:12}
