...
class Page:
    ...
    def update(self, x, mu1, mu2):
        ...
        line1, = self.ax.plot(x, mu1, '-', linewidth = 4, color = 'green' )
        line2, = self.ax.plot(x, mu2, '-', linewidth = 4, color = 'blue')
       # line2.set_dashes([12,12,12,12,12,12]) 
        ...
        fontP.set_size(20)
        leg1 = self.ax.legend((data1, line2, line1), ('data ($\leq 0.65 \%$ wt. SiO$_{2}$)', 'Seto', 'Extended model'), 'upper left', prop = fontP,fancybox=False)
