...
class Plot():
    ...
    def xy(self, widget):
        ...
        self.ax1.set_ylabel('Carrier Conc., $n_{e}$\n(x10$^{20}$ cm$^{-3}$)', fontsize = 18)
        ...
        self.ax2.set_ylabel('Mobility, $\mu_{e}$ \n(cm$^2$V$^{-1}$s$^{-1}$)', fontsize = 18)
        ...
        self.ax3.set_ylabel(r'Resistivity, $\rho$'' \n ($\Omega$.cm)', fontsize=18)
